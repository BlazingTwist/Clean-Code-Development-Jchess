...
export default function GameComponent(): ReactElement {
    // this is needed to show the game over dialog via onclick again once it has been closed
    const [isGameOverOpen, setIsGameOverOpen] = useState(false);
    const handleGameOverOpenChange = (newOpen: boolean) => {
        setIsGameOverOpen(newOpen);
    };
