...
public enum Hex3pPieceLayouts implements IPieceLayoutProvider {
    ...
    private static void populateCustomBoard(BoardController boardController) {
        ...
        boardController.placePawn(7, 15, PLAYER_LIGHT);
        boardController.placePawn(25, 15, PLAYER_LIGHT);

        boardController.placePawn(31, 9, PLAYER_MEDIUM);
        boardController.placePawn(22, 0, PLAYER_MEDIUM);

        boardController.placePawn(10, 0, PLAYER_DARK);
        boardController.placePawn(1, 9, PLAYER_DARK);
